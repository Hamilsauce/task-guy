            ...
            <ul>
                ...
                >
                    <li v-for="(task, index) in tasks" : key="index" class="taskItem">
							<span @click="toggleItemReveal(index)" class="task-text">{{ task.name }}</span>
...
let isValid = this.validateItemInput(this.task.name);
;
...
// this.$refs.inputField.focus();
            ...
            this.tasks.push({ name: this.task.name, id: this.setId(this.tasks), details: this.task.details });
this.setId(this.tasks, this.task)
...
return pushValidId(userId, objIds) ;

			function pushValidId(newId, arr) {
